                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 12,),
                      passWordField(text: 'Confirm Password', controller: mySignUp.confirmPasswordController, type: TextInputType.visiblePassword, isPassword: mySignUp.isPassword, iconButton: IconButton(onPressed: () => mySignUp.hidePass(), icon: mySignUp.isPassword
                             ? const Icon(Icons.visibility_off, color: Colors.deepOrange, size: 20,)
                             : const Icon(Icons.visibility, color: Colors.deepOrange, size: 20,),)),
                      const SizedBox(height: 12,),
